import { DictionaryService } from "@sitecore-content-sdk/nextjs";
...
export class DictionaryServiceFactory {
  ...
  create(siteName: string): DictionaryService {
    ...
    return new DictionaryService({
      ...
      */
      retries: {
        count: (process.env.GRAPH_QL_SERVICE_RETRIES && parseInt(process.env.GRAPH_QL_SERVICE_RETRIES, 10)) as number,
      },
    });
  }
}
