      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media screen and (max-width: 1024px) {
            ...
            ${elementID} #SlideText { font-size: 4.5vh !important; }
        }
        ...
        @media screen and (max-width: 479px) {
            ...
            ${elementID} #SlideText { font-size: 3.5vh !important; }
        }
        ...
        html[lang="fr"] ${elementID}.scene-container, ${elementID}.scene-container.quebec { background-position: center 33%; }
        ...
        @media (min-width: 768px) { .scene-container, .background-image { height: 60vh; } }
        @media (min-width: 1024px) { .scene-container, .background-image { height: 65vh; } }
        @media (min-width: 1280px) { .scene-container, .background-image { height: 70vh; } }

        .inviting-copy {
            color: #FFFFFF; font-size: 9vh; font-weight: 700; margin-bottom: 50px; line-height: 1.3; display: block; height: auto; position: static; background-color: transparent !important;
        }
        @media (min-width: 640px) { .inviting-copy { font-size: 8vh; } }
        @media (min-width: 768px) { .inviting-copy { font-size: 6vh; } }
        @media (min-width: 1024px) { .inviting-copy { font-size: 5vh; } }
        @media (min-width: 1280px) { .inviting-copy { font-size: 4vh; } }
        ...
        ${elementID} #SlideText { line-height: 1; font-size: 5.5vh; font-weight: 600; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.5); opacity: 0; animation: fadeIn 2s ease-in-out 0.75s forwards; }
...
export default JoyIsAgelessHeroAnimatedSlide;
